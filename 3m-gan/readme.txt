https://github.com/odegeasslbc/FastGAN-pytorch/blob/main/README.md
...
Different model and training configurations are needed on different datasets. You may have to tune the hyper-parameters to get the best results on your own datasets.
...
5. Other notes
The provided scripts are not well organized, contributions are welcomed to clean them.
An third-party implementation of this paper can be found here, where some other techniques are included. I suggest you try both implementation if you find one of them does not work.